...
public class SiberianStormWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SiberianStormWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SiberianStormWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SiberianStormWLAIW/InitOutcome.xml").getDocumentElement();
